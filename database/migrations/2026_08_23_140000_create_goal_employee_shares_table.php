...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('goal_employee_shares', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['goal_id', 'employee_id'], 'goal_employee_shares_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('goal_employee_shares');
    }
};
