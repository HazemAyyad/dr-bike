...
return new class extends Migration
{
    ...
    private const PERMISSION_ID = 46;

    private const NAME = 'نسخ مهمة موظف';

    private const NAME_EN = 'Clone Employee Task';
    ...
    public function up(): void
    {
        ...
        // إذا كان الرقم 46 محجوزاً لصلاحية أخرى، نُدرج بدون فرض الرقم لتفادي التعارض.
