...
class WhatsAppContact extends Model
{
    ...
    public function conversations() { return $this->hasMany(WhatsAppConversation::class, 'whatsapp_contact_id'); }
    public function messages() { return $this->hasMany(WhatsAppMessage::class, 'whatsapp_contact_id'); }
