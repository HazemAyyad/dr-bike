...
final class NotificationCatalog
{
    ...
    public static function types(): array
    {
        return [
            ...
            'sales_order_status_ready' => self::item('الطلبية جاهزة', 'sales_orders', 'high', 'library_correct_answer'),
            'sales_order_status_postponed' => self::item('تأجيل الطلبية', 'sales_orders', 'high', 'library_bell'),
            'sales_order_status_with_delivery' => self::item('الطلبية مع المندوب', 'sales_orders', 'high', 'shiply_motorcycle'),
            'sales_order_status_delivered' => self::item('تسليم الطلبية', 'sales_orders', 'high', 'shiply_delivered'),
            'sales_order_status_archived' => self::item('أرشفة الطلبية', 'sales_orders', 'normal', 'library_dry_pop'),
            'sales_order_status_review' => self::item('الطلبية قيد المراجعة', 'sales_orders', 'high', 'library_clear_announce'),
            'sales_order_status_stuck' => self::item('تعثر الطلبية', 'sales_orders', 'critical', 'shiply_stuck'),
            'sales_order_status_returned' => self::item('إرجاع الطلبية', 'sales_orders', 'critical', 'shiply_returned'),
            'sales_order_status_partial_delivered' => self::item('تسليم جزئي للطلبية', 'sales_orders', 'high', 'library_correct_answer'),
            'sales_order_status_partial_return' => self::item('إرجاع جزئي للطلبية', 'sales_orders', 'high', 'shiply_returned'),
            'sales_order_status_alternative_return' => self::item('إرجاع بديل للطلبية', 'sales_orders', 'high', 'shiply_returned'),
            'sales_order_status_canceled' => self::item('إلغاء الطلبية', 'sales_orders', 'critical', 'urgent'),
            'sales_order_shiply_handover' => self::item('تسليم الطلبية لشبلي', 'sales_orders', 'high', 'shiply_motorcycle'),
            'sales_order_shiply_delivered' => self::item('شبلي سلّم الطلبية', 'sales_orders', 'high', 'shiply_delivered'),
            'sales_order_shiply_status' => self::item('تحديث تتبع شبلي', 'sales_orders', 'high', 'shiply_motorcycle'),
