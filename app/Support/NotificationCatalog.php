...
final class NotificationCatalog
{
    ...
    public static function bundledSounds(): array
    {
        return [
            ...
            'library_correct_answer' => self::sound('مكتبة - تأكيد ناجح', 'library_correct_answer', 'library_correct_answer.mp3', 'dr_bike_library_correct_answer', 'library'),
            'library_message_pop' => self::sound('مكتبة - رسالة قصيرة', 'library_message_pop', 'library_message_pop.mp3', 'dr_bike_library_message_pop', 'library'),
            'library_happy_bells' => self::sound('مكتبة - أجراس سعيدة', 'library_happy_bells', 'library_happy_bells.mp3', 'dr_bike_library_happy_bells', 'library'),
            'library_arabian_harp' => self::sound('مكتبة - نغمة عربية', 'library_arabian_harp', 'library_arabian_harp.mp3', 'dr_bike_library_arabian_harp', 'library'),
            'library_clear_announce' => self::sound('مكتبة - تنبيه واضح', 'library_clear_announce', 'library_clear_announce.mp3', 'dr_bike_library_clear_announce', 'library'),
            'library_reward' => self::sound('مكتبة - مكافأة', 'library_reward', 'library_reward.mp3', 'dr_bike_library_reward', 'library'),
            'library_magic_marimba' => self::sound('مكتبة - ماريمبا', 'library_magic_marimba', 'library_magic_marimba.mp3', 'dr_bike_library_magic_marimba', 'library'),
            'library_digital_quick' => self::sound('مكتبة - رقمي سريع', 'library_digital_quick', 'library_digital_quick.mp3', 'dr_bike_library_digital_quick', 'library'),
            'library_bell' => self::sound('مكتبة - جرس هادئ', 'library_bell', 'library_bell.mp3', 'dr_bike_library_bell', 'library'),
            'library_dry_pop' => self::sound('مكتبة - نقرة خفيفة', 'library_dry_pop', 'library_dry_pop.mp3', 'dr_bike_library_dry_pop', 'library'),
        ];
    }
