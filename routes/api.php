...
Route::group(['middleware'=>['auth:sanctum','check.permission:Sales','refresh.token.expiry']] , function() {
   ...
   Route::post('/add/deposit' , [Deposits::class,'store']);
      ...
      Route::post('/sales/order/delete', [SalesOrdersController::class, 'destroy']);
...
Route::group(['middleware'=>['auth:sanctum','check.permission:Maintenance','refresh.token.expiry']] , function() {
    ...
    Route::post('/maintenance/payment' , [MaintenanceAPI::class,'addPayment']);
...
Route::group(['middleware'=>['auth:sanctum','refresh.token.expiry']] , function() {
    ...
    //incoming checks
      Route::post('/add/incoming/check' , [IncomingChecks::class,'store'])
          ->middleware('check.permission:Checks Incoming Create');
      ...
      Route::get('/check-notification-rules' , [CheckNotificationRulesController::class,'index'])
          ->middleware('check.permission:Checks Incoming View,Checks Outgoing View');
      ...
      Route::post('/cash/incoming/check/to/person' , [IncomingChecks::class,'cashCheckToPerson'])
          ->middleware('check.permission:Checks Incoming View');
...
Route::group(['middleware'=>['auth:sanctum','admin','refresh.token.expiry']] , function() {
  ...
  //  Route::get('/all/invoices' , [Invoices::class,'allInvoices']);
   ...
   //logs
    ...
    Route::get('/admin/notification-policies', [AdminNotificationSettingsController::class, 'policies']);
    Route::put('/admin/notification-policies/{type}', [AdminNotificationSettingsController::class, 'updatePolicy']);
    Route::post('/admin/notification-policies/{type}/reset', [AdminNotificationSettingsController::class, 'resetPolicy']);
    Route::get('/admin/notification-templates', [AdminNotificationSettingsController::class, 'templates']);
    Route::put('/admin/notification-templates/{type}', [AdminNotificationSettingsController::class, 'updateTemplate']);
    Route::get('/admin/notification-sounds', [AdminNotificationSettingsController::class, 'sounds']);
    Route::post('/admin/notification-sounds', [AdminNotificationSettingsController::class, 'storeSound']);
    Route::put('/admin/notification-sounds/{sound}', [AdminNotificationSettingsController::class, 'updateSound']);
    Route::delete('/admin/notification-sounds/{sound}', [AdminNotificationSettingsController::class, 'destroySound']);
    Route::get('/admin/notification-sounds/{sound}/file', [AdminNotificationSettingsController::class, 'soundFile']);
    Route::get('/admin/notification-sounds-manifest', [AdminNotificationSettingsController::class, 'soundManifest']);
