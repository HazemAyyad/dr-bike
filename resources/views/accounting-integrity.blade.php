...
@php
    ...
    $checkLabels = [
        ...
        'maintenance' => 'الصيانة', 'expenses' => 'المصروفات', 'assets' => 'الأصول والإهلاك',
...
<main class="wrap">
    ...
    <section class="panel danger-zone">
        ...
        <div class="panel-body">
            <div class="warning help"><strong>ماذا قد يتغير؟</strong> إنشاء/تحديث القيد المحاسبي للمصدر الفاشل، إعادة بناء Cost Snapshot فقط عندما تثبت بيانات FIFO التكلفة، وتعليم Failure كمحلول عندما يصبح القيد صالحًا. لن يعدّل أرصدة صندوق أو ذمم أو مخزون يدويًا، ولن يخمّن تكلفة، ولن يشغّل Cutover أو Opening Balances.</div>
