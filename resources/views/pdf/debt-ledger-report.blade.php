...
<body>
    ...
    <div class="summary">
        <span>إجمالي أخذت: <span class="taken">{{ number_format($total_taken, 2) }} {{ $currencyLabel }}</span></span>
        <span>إجمالي أعطيت: <span class="given">{{ number_format($total_given, 2) }} {{ $currencyLabel }}</span></span>
        <span>الرصيد النهائي:
