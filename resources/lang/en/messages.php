...
return [
    ...
    'subtask_rejected' => 'Subtask has been marked as declined',
    'subtask_not_completed' => 'The subtask is not completed',
    'subtask_completion_undone' => 'Subtask completion has been undone',
    'task_completed_can_not_change_subtasks' => 'Subtasks cannot be changed after the task is approved',
    ...
    'attendance_day_updated' => 'Attendance day updated successfully',
    'check_in_must_match_work_date' => 'Check-in time must be on the same work day',
    'attendance_overtime_approved' => 'Overtime approved',
   ...
   //draw
    ...
    'sales_order_handover_customer_required' => 'Customer must be selected before handover.',
    'sales_order_handover_phone_required' => 'Customer phone is required before handover.',
    'sales_order_handover_address_required' => 'Delivery address is required before handover.',
    'sales_order_taxi_number_required' => 'Taxi number is required.',
    'sales_order_taxi_driver_required' => 'Taxi driver name is required.',
    'sales_order_taxi_phone_required' => 'Taxi contact phone is required.',
    'sales_order_office_number_required' => 'Delivery office reference number is required.',
    'sales_order_office_name_required' => 'Delivery office name is required.',
    'sales_order_office_driver_required' => 'Delivery driver name is required.',
    'sales_order_office_phone_required' => 'Driver contact phone is required.',
    'sales_order_office_vehicle_required' => 'Delivery vehicle number is required.',
    'sales_order_created_note' => 'New order created',
    ...
    'shiply_employee_email_invalid' => 'Employee account email is invalid. It must be a real email registered in Shiply.',
    'shiply_unauthorized' => 'Shiply rejected the request. Ensure your email (:email) is registered as an employee in Shiply (same mode: test or live).',
    'shiply_api_unauthorized' => 'Shiply API key rejected in :mode mode. Check SHIPLY_API_KEY_TEST/LIVE in .env and delivery mode in settings.',
    'shiply_event_handover_submitted' => 'Parcel submitted to Shiply',
    'shiply_parcel_status_draft' => 'Draft',
    'shiply_parcel_status_submitted' => 'Submitted to Shiply',
    'shiply_parcel_status_on_the_way' => 'On the way',
    'shiply_parcel_status_attempt_to_deliver' => 'Delivery attempt',
    'shiply_parcel_status_pending' => 'Pending',
    'shiply_parcel_status_delivered' => 'Delivered',
    'shiply_parcel_status_returned' => 'Returned',
    ...
    'sales_order_shiply_status_title' => 'Shiply update — :serial',
    'sales_order_shiply_status_body' => 'Parcel :parcel (:customer): :status',
    'sales_order_shiply_returned_title' => 'Shiply returned — :serial',
    'sales_order_shiply_returned_body' => 'Order :serial (:customer) was returned by Shiply. Parcel: :parcel',
    'sales_order_media_required_items_group' => 'A photo of all items together is required before marking ready or handover.',
    'sales_order_media_required_packaged' => 'A post-packaging photo is required before handover to delivery.',
    'sales_order_media_category_items_group' => 'Items group photo',
    'sales_order_media_category_packaged' => 'Post-packaging photo',
    'sales_order_media_category_testing' => 'Testing photo/video (optional)',
    'sales_order_media_category_document' => 'Document / warranty (optional)',
    'sales_order_media_category_general' => 'General',
    'sales_order_settlement_box_required' => 'Select a cash box when recording a settlement amount.',
    'sales_order_marked_stuck' => 'Order marked as stuck.',
    'sales_order_bulk_done' => ':count order(s) updated.',
    'sales_order_bulk_action_invalid' => 'Unsupported bulk action.',
